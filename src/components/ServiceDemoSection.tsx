...
const ServiceDemoSection = () => {
  ...
  const steps = [
    ...
    },
    {
      id: 2,
      icon: MessageSquare,
      title: t("howItWorks.steps.validation.title"),
      description: t("howItWorks.steps.validation.description"),
    },
    {
      id: 3,
      icon: Paintbrush,
  ...
  const MobileStepCard = ({ step }: { step: typeof steps[0] }) => (
    <div className="bg-card rounded-2xl p-5 shadow-card border border-border/40 h-full">
      ...
      <div className="bg-muted/30 rounded-xl p-3 space-y-2">
        {step.id === 1 && (
          <>
            <div className="h-7 bg-muted/50 rounded flex items-center px-3 text-xs text-muted-foreground">{t("howItWorks.demo.projectType")}</div>
            <div className="h-7 bg-muted/50 rounded flex items-center px-3 text-xs text-muted-foreground">{t("howItWorks.demo.estimatedBudget")}</div>
          </>
        )}
        {step.id === 2 && (
          <>
            <div className="flex items-center gap-2 text-xs">
              ...
              <span className="text-foreground">{t("howItWorks.demo.scopeValidated")}</span>
            </div>
            <div className="flex items-center gap-2 text-xs">
              <Check className="w-4 h-4 text-success" />
              <span className="text-foreground">{t("howItWorks.demo.delay")}</span>
            </div>
          </>
        )}
        {step.id === 3 && (
        ...
        {step.id === 4 && (
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-medium text-success">{t("howItWorks.demo.siteDelivered")}</span>
          </div>
        )}
      </div>
    </div>
                ...
                <div className="bg-muted/30 rounded-xl overflow-hidden">
                  ...
                  <div className="p-4 lg:p-6 h-48 lg:h-56 relative overflow-hidden">
                    ...
                    >
                      <div className="space-y-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">{t("howItWorks.demo.scopeValidated")}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Check className="w-5 h-5 text-green-500" />
                          <span className="text-sm">{t("howItWorks.demo.delay")}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Check className="w-5 h-5 text-green-500" />
                          <span className="text-sm">{t("howItWorks.demo.price")}</span>
                        </div>
                      </div>
                    </motion.div>
                    ...
                    >
                      ...
                      <span className="text-lg font-semibold text-green-600">{t("howItWorks.demo.siteDelivered")}</span>
                    </motion.div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-xs font-medium text-primary">{t("howItWorks.step")} {step.id}</span>
                    </div>
