      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 mb-16">
          <div className="lg:col-span-2">
            ...
            <a href="tel:+13463683103" className="flex items-center gap-2 mb-3 text-white/70 hover:text-primary transition-colors">
            ...
            <a href="https://wa.me/13463683103" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 mb-4 text-white/70 hover:text-green-500 transition-colors">
