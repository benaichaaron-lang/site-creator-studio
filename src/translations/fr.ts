export const fr = {
  ...
  packs: {
    ...
    subtitle: "Prix fixes. Sans frais cachés.",
    popular: "Populaire",
  ...
  footer: {
    cta: {
      ...
      subtitle: "Commencez par un brief gratuit. Décidez après.",
      noPayment: "Aucun paiement requis avant validation du projet.",
      startBrief: "Démarrer mon brief",
      seePricing: "Voir les tarifs",
    },
    description: "Sites web professionnels, livrés rapidement, avec paiement crypto. Simple, moderne, transparent.",
    trusted: "Fait confiance par des entrepreneurs et entreprises depuis 2023.",
