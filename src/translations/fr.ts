export const fr = {
  ...
  hero: {
    ...
    title: "Votre site pro, livré",
    titleHighlight: "en 7 jours chrono",
    subtitle: "Design haute conversion • Prix fixe garanti • Paiement Crypto & Carte acceptés",
    subtitleTeam: "Chaque projet géré par une vraie équipe de développeurs expérimentés.",
    mobileTitle: "Votre site pro livré en",
    mobileSubtitle: "Prix fixe garanti. Zéro mauvaise surprise.",
    mobileSubtitle2: "Paiement crypto ou carte bancaire.",
    trustBadges: {
      delivery: "7 jours",
      fixedPrice: "Prix fixe garanti",
      cryptoCard: "Crypto/Carte",
      deliveryLong: "Livré en 7 jours chrono",
    },
    cta: {
      startBrief: "Lancer mon projet maintenant",
      seePacks: "Voir les offres",
    },
    form: {
      ...
      submit: "Lancer mon projet maintenant →",
      submitting: "Envoi en cours...",
      required: "*",
      optional: "optionnel",
      footer: "Sans engagement • Aucun paiement avant validation",
      success: {
        title: "Projet reçu ! 🎉",
        message: "Notre équipe analyse votre brief et vous contacte sous 24h avec une proposition détaillée.",
        createAccount: "Créer mon espace client",
      },
    },
    websiteTypes: {
  ...
  trust: {
    ...
    credibility: "Entrepreneurs, startups Web3 et PME nous font confiance pour lancer leur présence en ligne rapidement.",
    sectors: {
      ecommerce: "E-commerce",
      startups: "Startups",
      sme: "PME",
  ...
  packs: {
    badge: "Nos Offres",
    title: "Prix fixes, zéro surprise",
    subtitle: "Tout est inclus. Aucun frais caché. Paiement après validation.",
    popular: "Populaire",
    ...
    responsiveIncluded: "Design responsive inclus",
    ...
    starter: {
      name: "Starter",
      delay: "5 jours",
      features: ["Landing page", "Design responsive", "Formulaire de contact"],
      moreFeatures: ["1 an d'hébergement", "Certificat SSL", "SEO basique"],
    },
    business: {
      name: "Business",
      delay: "7 jours",
      features: ["Jusqu'à 5 pages", "Design premium", "Formulaires avancés"],
      moreFeatures: ["1 an d'hébergement", "Certificat SSL", "SEO complet", "Analytics"],
    },
    premium: {
      name: "Premium",
      delay: "10 jours",
      features: ["Pages illimitées", "Design sur-mesure", "Toutes intégrations"],
      moreFeatures: ["2 ans d'hébergement", "Certificat SSL", "SEO avancé", "Support prioritaire"],
    },
  },
  ...
  howItWorks: {
    ...
    demo: {
      ...
      scopeValidated: "Périmètre validé",
      delay: "Délai: 7 jours",
  ...
  contact: {
    ...
    form: {
      ...
      success: {
        ...
        createAccount: "Créez un compte pour suivre votre projet en temps réel",
    ...
    list: [
      {
        ...
        content: "Un travail remarquable ! Notre boutique en ligne a vu ses ventes exploser de 65% dès le premier mois. L'équipe a parfaitement capté l'essence de notre marque artisanale.",
      },
      {
        name: "Théophane Bergeret",
        role: "Directeur Général",
        company: "Nexoria Tech",
        content: "Processus fluide et résultat au-delà de nos attentes. 6 jours chrono pour un site qui impressionne nos investisseurs. Je recommande sans hésiter.",
      },
      {
        name: "Apolline Deschamps-Rivière",
        role: "CEO",
        company: "Solstice Énergie",
        content: "Très professionnels. Ils ont su transformer notre vision complexe en une interface claire et intuitive. Notre taux de conversion a triplé.",
      },
      {
        name: "Cyprien Beaumont-Latour",
        role: "Co-fondateur",
        company: "Osmose Wellness",
        content: "Rapport qualité-prix imbattable. Le site est moderne, rapide, et nos clients adorent l'expérience utilisateur. Zéro regret.",
      },
      {
        name: "Séraphine Delacroix",
        role: "Directrice Marketing",
        company: "Velours & Co",
        content: "J'ai travaillé avec beaucoup d'agences, mais MySiteFactory a une approche unique. Réactifs, créatifs, et le paiement crypto m'a fait gagner un temps fou.",
      },
      {
        name: "Maximilien Vernet-Chassagne",
        role: "Entrepreneur",
        company: "Horizon Ventures",
        content: "Mon troisième projet avec eux. Chaque fois, livraison dans les temps, qualité irréprochable. C'est rare de trouver une équipe aussi fiable.",
      },
    ],
  },
  ...
  footer: {
    cta: {
      title: "Votre site pro livré en 7 jours.",
      subtitle: "Brief gratuit. Devis sous 24h. Paiement uniquement après validation.",
      noPayment: "Aucun paiement requis avant validation du projet. Zéro risque.",
      startBrief: "Lancer mon projet maintenant",
      seePricing: "Voir les offres",
    },
    description: "Sites web professionnels haute conversion, livrés en 7 jours, paiement crypto ou carte. Simple, moderne, transparent.",
    trusted: "Fait confiance par des entrepreneurs, startups Web3 et PME depuis 2023.",
    readyToWork: "Prêt à travailler avec vous",
    services: "Services",
    company: "Entreprise",
    legal: "Légal",
    links: {
      starterPack: "Pack Starter",
      businessPack: "Pack Business",
  ...
  admin: {
    ...
    orders: {
      ...
      toasts: {
        ...
        error: "Erreur",
        cantUpdate: "Impossible de mettre à jour",
      },
    },
    packs: {
      title: "Packs",
  ...
  authPrompt: {
    ...
    description: "Créez un compte gratuit pour accéder à votre espace client et suivre vos projets en temps réel.",
    signUp: "Créer un compte",
